            ...
            <Card className="border border-gray-200 dark:border-gray-700">
              ...
              <form onSubmit={handleSendMessage} className="space-y-4">
                ...
                <button
                  ...
                  className="px-6 py-3 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 disabled:cursor-not-allowed text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center gap-2 min-w-[120px]"
                >
                  {sendingMessage ? (
                    <>
